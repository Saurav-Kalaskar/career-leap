...
func NormalizeStatus(raw string) string {
	...
	case strings.Contains(s, "do not apply") || strings.Contains(s, "do_not_apply") || s == "skip" || strings.Contains(s, "geo blocker"):
		return "skip"
	case strings.Contains(s, "interview") || strings.Contains(s, "interviewing"):
		return "interview"
	case s == "offer" || strings.Contains(s, "offered"):
		return "offer"
	case strings.Contains(s, "responded") || strings.Contains(s, "replied"):
		return "responded"
	...
	case strings.Contains(s, "rejected") || strings.Contains(s, "declined"):
		return "rejected"
	case strings.Contains(s, "discarded") || strings.Contains(s, "closed") || strings.Contains(s, "canceled") ||
		strings.HasPrefix(s, "duplicate") || strings.HasPrefix(s, "dup"):
		return "discarded"
	case strings.Contains(s, "evaluated") || strings.Contains(s, "reviewed") || s == "conditional" || s == "hold" || s == "monitor" || s == "review" || s == "verify":
		return "evaluated"
	default:
		return s
	}
